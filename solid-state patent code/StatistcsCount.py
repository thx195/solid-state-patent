...
# 保存为CSV文件
patent_count_df.to_csv('./Results/patent_count_by_year_and_country.csv')
dwpi_total_df.to_csv('./Results/dwpi_total_by_year_and_country.csv')

print("CSV文件生成完毕：'patent_count_by_year_and_country.csv' 和 'dwpi_total_by_year_and_country.csv'")
