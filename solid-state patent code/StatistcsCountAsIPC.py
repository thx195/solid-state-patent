...
# 保存为CSV文件
patent_count_df_1.to_csv('./Results/patent_count_by_year_and_IPC.csv')
patent_count_df_2.to_csv('./Results/patent_count_by_year_IPC_and_country.csv')

print("CSV文件生成完毕：'patent_count_by_year_and_IPC.csv' 和 'patent_count_by_year_IPC_and_country.csv'")
